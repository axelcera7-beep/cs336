...
valid_data_path = config_data["valid_data_path"]
checkpoint_dir = config_data["checkpoint_dir"]
dataset = config_data["dataset"]

num_steps = config_training["num_steps"]
lr_min = config_training["lr_min"]
lr_max = config_training["lr_max"]
warmup_steps = config_training["warmup_steps"]
batch_size = config_training["batch_size"]
max_l2_norm = config_training["max_l2_norm"]
steps_saves = config_training["steps_saves"]
steps_valid_loss = config_training["steps_valid_loss"]
steps_train_loss = config_training["steps_train_loss"]
device = config_training["device"]
